		...
		extend: {
			...
			keyframes: {
				...
				blob2: {
					...
					'33%': { transform: 'translate(-20px, 140px) scale(1.2)' },
					'66%': { transform: 'translate(60px, 100px) scale(0.9)' },
					'100%': { transform: 'translate(0px, 50px) scale(1)' },
				},
				blob3: {
					'0%': { transform: 'translate(0px, 0px) scale(1)' },
					'25%': { transform: 'translate(450px, 500px) scale(1.2)' },
					'50%': { transform: 'translate(900px, 200px) scale(1.5)' },
					'75%': { transform: 'translate(450px, -240px) scale(1.2)' },
					'100%': { transform: 'translate(0px, 0px) scale(1)' },
				},
				blob4: {
					'0%': { transform: 'translate(0px, 0px) scale(1)' },
					'33%': { transform: 'translateY(30rem) scale(1.2)' },
