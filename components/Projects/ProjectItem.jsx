...
const ProjectItem = ({ title, backgroundImg, url, subtitle, info }) => {
	return (
		<Link href={url} className='cursor-pointer'>
			<div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:transition-opacity hover:bg-gradient-radial from-[#516ce5] to-[#709dff] ease-in duration-150'>
				<Image
